...
- **从外面往会话里敲**([03 §5](03-http.md))。shellbase 的 api/terminals.md 里明写着
...
ssh 给得更好([03 §2](03-http.md))。**同一个问题,两边的答案不同,
...
**纯批处理不需要这个,请用 ssh**([03 §2](03-http.md))。
...
| **读终端内容**(抓屏、拿退出码、输出流) | 人(打开 URL)或 ssh([03 §2](03-http.md)) |
